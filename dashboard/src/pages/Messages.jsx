        ...
        <div className='flex items-start bg-[#F5F5F5]'>
            ...
            <div className='w-full'>
                ...
                <div className='m-[30px] bg-white p-[30px] rounded-[10px] flex'>
                    ...
                    <div className='mt-[30px] ml-[35px] border border-solid border-Cgray w-[800px] rounded-[10px]'>
                        ...
                        <div>
                            ...
                            <div className='flex mt-[24px] ml-[23px]'>
                                <img src={ava1} alt="ava" className='w-[50px] h-[50px] rounded-[50%]' />
                                <div className='bg-Lightblue ml-[14px] rounded-s-none rounded-e-[10px] rounded-b-[10px]'>
                                <h5 className='py-[10px] pl-[14px] pr-[22px] text-messagesTitle text-Cblack'>Hi, I hope you are doing well, yesterday you have gave a pen This <br />
                                    very nice, i am very happy for this.yesterday you have gave <br />
                                    a pen This very nice
                                </h5>
                                </div>
                            </div>
                            <p className='text-end mt-[10px] text-messagesSubTitle text-Cgray'>4:30</p>
                            </div>
                            <div className='flex mt-[35px] justify-items-end'>
                            <div className='bg-Lightblue ml-[14px] rounded-s-none rounded-e-[10px] rounded-b-[10px]'>
                                <h5 className='py-[10px] pl-[14px] pr-[22px] text-messagesTitle text-Cblack'>Hi, I hope you are doing well, yesterday you have gave a pen This <br />
                                    very nice, i am very happy for this.yesterday you have gave <br />
                                    a pen This very nice
                                ...
                                <img src={profile} alt="ava" className='w-[50px] h-[50px] rounded-[50%]'  />
                            </div>
                        </div>
                    </div>
                </div>
